                            ...
                            <div class="pl-lg-2">
                                ...
                                <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" id="search_plate_no"
                                        ...
                                        placeholder="R-829-VT" value="{{old('plate_no')}}" required autofocus maxlength="8" onkeyup="formatInput(this.value)">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            <form id="store" method="post" action="{{ route('vehicle.store') }}" autocomplete="off"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="brand" id="brand" class="form-control"
                                                    placeholder="{{ __('custom.brand') }}" value="{{old('brand')}}" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="type" id="type" class="form-control"
                                                    placeholder="{{ __('custom.type') }}" value="{{old('type')}}" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="apk" id="apk" class="form-control"
                                                    placeholder="{{ __('custom.apk') }}" value="{{old('apk')}}" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="first_registeration"
                                                    ...
                                                    placeholder="{{ __('custom.first_registeration') }}" value="{{old('first_registeration')}}"
                                                    required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="last_ascription" id="last_ascription"
                                                    ...
                                                    value="{{old('last_ascription')}}" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="bought_from" id="bought_from"
                                                    ...
                                                    value="{{old('bought_from')}}" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="purchase_amount" id="purchase_amount"
                                                    ...
                                                    value="{{old('purchase_amount')}}" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="remainder_amount"
                                                    ...
                                                    placeholder="{{ __('custom.remainder_amount') }}" value="{{old('remainder_amount')}}"
                                                    required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <select type="text" name="remainder_instrument"
                                                    ...
                                                    placeholder="{{ __('custom.remainder_instrument') }}" value="{{old('remainder_instrument')}}"
                                                    required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group ">
                                                ...
                                                <input type="email" name="email"
                                                    ...
                                                    placeholder="{{ __('custom.email') }}" value="{{old('email')}}"
                                                    required>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group ">
                                                ...
                                                <select type="text" name="vehicle_status"
                                                    ...
                                                    placeholder="{{ __('custom.vehicle_status') }}" value="{{old('vehicle_status')}}"
                                                    required>
                                                    <option value="">Select Vehicle Status</option>
                                                    <option value="pending">Pending</option>
                                                    <option value="finished">Picked UP/Finished</option>
                                                </select>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group ">
                                                ...
                                                <select type="text" name="payment_status"
                                                    ...
                                                    placeholder="{{ __('custom.payment_status') }}" value="{{old('payment_status')}}"
                                                    required>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group ">
                                                ...
                                                <textarea name="comment" id="comment" rows="10" class="form-control"
                                                    placeholder="{{ __('custom.comment') }}" required>{{old('comment')}}</textarea>
                                ...
                                <div>
                                    <input type="hidden" name="plate_no" id="plate_no" value="{{old('')}}">
...
<script>
    function formatInput(txt){
        let ftxt = txt.toUpperCase()
        ftxt = ftxt.replace(/-/g, '')
        ftxt = ftxt.replace(/(.{1})(.{3})/, "$1-$2-")
        document.getElementById('search_plate_no').value  = ftxt.substr(0, 8)

    }
    window.onload = function(){
        document.getElementById('search_plate_no').addEventListener("click", function(){
            formatInput(this.value)
        });
    }
    ...
    function getPlateData() {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                // console.log(res)
                demo.showCustomNotification('top', 'center', res.message, 4)
